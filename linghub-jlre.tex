...
\begin{figure}
    \includegraphics[width=0.48\textwidth]{img/eval_lang_per_request_2016_Mar.png}
    \includegraphics[width=0.48\textwidth]{img/eval_lang_per_res_2016_Mar.png}
    \caption{\label{fig:language-constraints} evenly-sclaled
      distribution language constraints in the CML requests and
      $\log_{10}$-scaled distribution of resources available in
      Linghub covering specified numbers of languages}
\end{figure}
...
\newsavebox{\imgbox}
\savebox{\imgbox}{\includegraphics[width=0.53\textwidth]{img/eval_facet_coverage_2016_Mar.png}}
\showthe\ht\imgbox 
\begin{figure}
