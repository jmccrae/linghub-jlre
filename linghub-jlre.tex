...
It is not an infrequent case that users searching LRs want to determine which licenses are acceptable for their purposes. 
...
\item The CLARIN Virtual Language Observatory (https://vlo.clarin.eu) also offers a faceted browsing, and one of the 8 facets is devoted to the 'availability'. Many of the resources fall under diffuse categories (such as "`open"' or "`free"') without referring the actual licenses. The metadata describing the license is a free text instead a URI neatly determining the license in use. 
\item ALVEO PENDING TO BE DONE
