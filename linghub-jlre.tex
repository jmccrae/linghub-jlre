...
all. The decreasing number of requests for higher language restriction count with a
...
are shown in Figure~\ref{fig:freetext-rel} and Table~\cite{tab:rel}.
...
\begin{table}
    \begin{tabular}{lcccc}
        \toprule
        Query & \shortstack{Search Results\\Count} &
        \shortstack{Percentage\\Relevant} &
        \shortstack{SPARQL Results\\Count}
        & \shortstack{Percentage\\Relevant} \\
        \midrule
1&88&11.36\%&60&23.33\%\\
2&60&10.00\%&63&3.17\%\\
